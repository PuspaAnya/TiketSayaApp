...
public class TicketCheckoutAct extends AppCompatActivity {
    ...
    TextView text_jumlah_tiket, texttotalharga, textmybalance, nama_wisata, lokasi, ketentuan;
    ...
    //karna kita ingin membuat transaksi secara unik
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_buy_ticket.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //menyimpan data user dari firebase dan membuat tabel baru "MyTickets"
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent backtoprev = new Intent(TicketCheckoutAct.this, TicketDetailAct.class);
